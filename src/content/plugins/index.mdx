...
| [`ChunksWebpackPlugin`](/plugins/chunks-webpack-plugin/)                        | 번들을 제공하기 위해 엔트리 포인트 및 청크 관계가 포함된 HTML 파일 생성       |
...
| [`SvgChunkWebpackPlugin`](/plugins/svg-chunk-webpack-plugin/)                   | 엔트리 포인트의 의존성을 기반으로 SVGO에 의해 최적화된 SVG 스프라이트 생성    |
