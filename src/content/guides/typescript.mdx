...
TypeScript 코드에서 [`import.meta.webpack`](/api/module-variables/#importmetawebpack)과 같은 webpack 관련 기능을 사용할 수 있습니다. 그리고 webpack은 이에 대한 타입도 제공합니다. TypeScript [`reference`](https://www.typescriptlang.org/docs/handbook/triple-slash-directives.html#-reference-types-) 지시문을 추가하여 선언하기만 하면 됩니다.
...
자세한 내용은 [블로그 포스트를](https://devblogs.microsoft.com/typescript/the-future-of-declaration-files-2/) 참고하세요.
