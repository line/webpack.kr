...
기존 파일을 감시할 수 있게 만들기 위해 로더 결과의 의존성으로 파일을 추가합니다. 예를 들어, [`sass-loader`](https://github.com/webpack/sass-loader), [`less-loader`](https://github.com/webpack-contrib/less-loader)는 가져온 `css` 파일이 변경될 때마다 이를 사용하여 재컴파일합니다.
