...
T> 이전 예제에서는 로더를 사용하여 CSS 파일을 로드했지만, webpack에는 CSS를 처리하고 스타일을 웹페이지에 자동으로 삽입할 수 있는 실험적인 옵션([`experiments.css`](https://webpack.js.org/configuration/experiments/))이 있습니다.
