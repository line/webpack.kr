...
[`reasons`](#statsreasons)를 원래 모듈별로 그룹화해 많은 reasons를 방지합니다.
...
T> [`세부 사전 설정`](#stats-presets)은 [`modulesSpace`](#statsmodulesspace)와 [`assetsSpace`](#statsassetsspace) 그리고 [`reasonsSpace`](#statsreasonsspace)를 기본으로 1000으로 제한합니다.
